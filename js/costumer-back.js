// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// COSTUMER BACK — Quiz multi-step, submit, tracking
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function updateProgress() {
    const pct = (quizState.currentStep / totalSteps) * 100;
  ...
  form.addEventListener('submit', async function (e) {
    ...
    const errorEl = getStepEl(totalSteps).querySelector('.quiz-error');
    ...
    try {
      ...
      window.dataLayer.push({
        ...
        tempo_negocio: quizState.answers.tempo_negocio,
        retencao_atual: quizState.answers.retencao_atual,
      });
      if (typeof gtag !== 'undefined') {
        gtag('event', 'generate_lead', { event_category: 'Quiz', event_label: 'Sistema Personalizado' });
      }
      ...
      const waMessage = encodeURIComponent('quero saber como funciona o sistema pro meu negócio');
